...
`minikube mount --uid=10001 --gid=10001 ~/Google\ Drive/공유\ 드라이브/<shared-drive>:/mnt/drive` 명령으로 호스트 Drive 폴더를 Pod 내 `/data/drive`에 ReadOnlyMany hostPath PV(100 Gi)로 노출한다.
