...
```
Host path:       ~/Google Drive/Shared Drive/<shared-drive>
...
| `second-brain-web-deployment.yaml` | Deployment | <web-app>, references BRAIN_API_URL |
...
minikube mount "/Users/user/Google Drive/Shared Drive/<shared-drive>:/mnt/drive" --uid=10001 --gid=10001 &
