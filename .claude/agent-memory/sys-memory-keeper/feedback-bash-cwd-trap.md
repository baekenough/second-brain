...
**Why**: 2026-04-13 second-brain 세션에서 `mv ~/workspace/baekenough/<old-repo> ~/workspace/<old-repo>` 직후 모든 Bash 명령이 차단됨. Glob도 ripgrep posix_spawn 실패. 오직 Read/Write/Edit (절대 경로) 만 동작.
