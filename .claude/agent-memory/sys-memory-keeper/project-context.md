...
- **경로**: `/Users/user/workspace/baekenough/second-brain`
...
| 계정 | 상태 | 용도 |
|------|------|------|
| <maintainer> | active | 현재 gh CLI 사용 계정 (baekenough org 소속) |
...
- **로컬 sync 폴더**: `~/Google Drive/공유 드라이브/<shared-drive>`
...
| Google Drive | 활성 | FS 스캔 (~/Google Drive/공유 드라이브/<shared-drive>) |
