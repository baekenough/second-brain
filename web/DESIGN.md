<!--
Vendored from https://github.com/VoltAgent/awesome-design-md/blob/main/design-md/linear.app/DESIGN.md
Vendored: 2026-08-17

CAVEAT (load-bearing, do not soften): these specs are extracted from MARKETING sites.
The display type scale (e.g. display-xl at 80px) is NOT appropriate for application UI.
Colors, surfaces, hairlines, and the single-accent discipline are adopted as-is;
the type scale is re-derived for application density — see
docs/superpowers/plans/2026-08-17-ask-capture-frontend.md Task 1.
-->
